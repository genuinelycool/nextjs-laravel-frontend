...
const Menu = () => {
  ...
  const [openMenuMoblie, setOpenMenuMoblie] = useState(false);
  ...
  return (
    <>
      <div className={`header-menu bg-white ${fixedHeader ? "fixed" : ""} `}>
        <div className="container flex items-center justify-between h-20">
          ...
          <div className="menu-center-block h-full">
            <ul className="menu-nav flex items-center xl:gap-2 h-full">
              ...
              >
                <Link
                  className="nav-link text-title flex items-center"
                  href="/"
                >
                  <span>Home</span>
                </Link>
              ...
              <li
                className={`nav-item h-full flex items-center justify-center 
                    home ${pathname === "/case-studies" ? "active" : ""} `}
              >
                <Link
                  className="nav-link text-title flex items-center"
                  href="/case-studies"
          ...
          <div className="menu-right-block flex items-center">
            ...
            <div
              ...
              onClick={() => setOpenMenuMoblie(!openMenuMoblie)}
            >
        ...
        <div id="menu-mobile-block" className={` ${openMenuMoblie && "open"} `}>
          <div className="menu-mobile-main">
            <div className="container">
              <ul className="menu-nav-mobile h-full pt-1 pb-1">
                <li
                  className="nav-item-mobile h-full flex-column 
                  gap-2 pt-2 pl-3 pr-3 pb-2 pointer"
                >
                  <a
